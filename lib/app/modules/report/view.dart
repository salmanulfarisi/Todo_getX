  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: SafeArea(child: Obx(() {
          ...
          var compleatedTasks = homeController.getTotoalDoneTasks();
          var liveTasks = createdTasks - compleatedTasks;
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    _buildStatus(
                        Colors.orange, compleatedTasks, 'Compleated Tasks'),
